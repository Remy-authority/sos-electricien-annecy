...
File d'attente des articles préparés en avance : ils sont **invisibles du site** (aucun loader ne lit ce dossier) jusqu'à ce que la GitHub Action `publish-article` en publie un (du lundi au vendredi, depuis le 25/09/2026) en le déplaçant vers `content/conseils/`.
