...
seoTitle: "Différence entre disjoncteur et fusible (et différentiel)"
slug: "disjoncteur-fusible-differentiel-differences"
description: "Fusible ou disjoncteur, différentiel ou pas : ce que protège chaque élément de votre tableau, et comment repérer celui qui a coupé lors d'une panne."
date: "2026-07-26"
category: "Normes"
cover: "/conseils/disjoncteur-fusible-differentiel-differences-v2.jpg"
...
![Rangée de disjoncteurs modulaires blancs sur rail DIN, avec un interrupteur différentiel et son bouton de test](/conseils/disjoncteur-fusible-differentiel-differences-1-v2.jpg)
...
Face à une coupure, regarder quel élément a réellement déclenché donne une première indication précieuse avant même d'appeler un professionnel : un disjoncteur de ligne isolé oriente vers un circuit ou un appareil précis, tandis qu'un différentiel qui coupe tout un groupe de circuits oriente vers une fuite de courant plus difficile à localiser sans matériel de diagnostic. Pour un logement équipé d'un tableau ancien mêlant fusibles et disjoncteurs, à Annecy ou avec un [électricien à Seynod](/zones/seynod), un état des lieux permet de clarifier ce que chaque protection couvre réellement, et ce qui manque éventuellement pour une sécurité complète. Remplacer les derniers fusibles fait partie d'une [remise aux normes du tableau électrique](/services/remise-aux-normes-tableau-electrique), dont vous trouverez le [prix d'un nouveau tableau électrique](/tarifs) sur notre page de prix.
