...
faq:
  ...
  - q: "Peut-on remettre en route un chauffage électrique resté éteint plusieurs années ?"
    a: "C'est possible, mais un appareil resté longtemps hors service mérite une vérification plus attentive avant remise sous tension prolongée, en particulier si le câblage ou le thermostat sont anciens. Au moindre signe suspect, odeur, bruit ou boîtier qui chauffe, coupez-le et faites-le examiner."
---
