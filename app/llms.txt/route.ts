...
export function GET() {
  ...
  const lines: string[] = [
    ...
    '',
    '## Activité',
    `${businessName} est un service de ${trade.toLowerCase()} à ${city} et dans son agglomération. Nous diagnostiquons précisément l'origine de chaque panne électrique avant toute intervention, du simple dépannage jusqu'au remplacement de tableau, la mise aux normes NF C 15-100 ou l'installation d'une borne de recharge pour véhicule électrique.`,
    '',
    ...
    `- Tarifs : ${absUrl('/tarifs')}`,
    `- Conseils : ${absUrl('/conseils')}`,
    '',
    '## Bon à savoir',
    "- Devis gratuit et sans engagement ; les frais de déplacement et les prix de référence sont publiés sur la page Tarifs.",
